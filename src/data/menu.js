// Меню АРЧИ. Цены в кыргызских сомах (с).
...
// ВАЖНО: текущий список и фото — демо от шаблона la-cafe; заказчик пришлёт
// свой список блюд (европейская, восточная, национальная, турецкая кухни).
...
export const dishes = {
  ...
  coffee: [
    {
      name: 'Капучино',
      description: 'Эспрессо, бархатное молоко и шапка плотной пены. Классика жанра.',
      price: 150,
      imgKey: 'cappuccino',
      emoji: '☕',
      tag: 'классика',
  ...
  desserts: [
    {
      name: 'Тирамису',
      description: 'Классический тирамису на сливочном маскарпоне с эспрессо и какао.',
      price: 280,
      imgKey: 'tiramisu',
      emoji: '🍰',
      tag: 'хит',
